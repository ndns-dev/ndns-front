...
export const LoadingModal: React.FC<LoadingModalProps> = ({
  ...
  return (
    ...
    >
      <div className="absolute top-1/2 transform -translate-y-1/2 bg-white dark:bg-gray-800 rounded-lg p-6 shadow-xl max-w-md w-full flex flex-col items-center">
